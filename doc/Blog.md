...
Для создания инофрмера для модуля Блог используется параметр "module":"bl". В данном информере возможны три типа контента. Для каждого типа возможен свой набор параметров. Ниже перечислены типы материалов и параметры их вывода. Для всех типов данных используется параметр title. Данный параметр содержит имя информера в списке информеров панели управления
...
| max_columns | Максимальное количесмтво колонок |
| curdate | Выводит материалы за период. 1 - День; 2 - Месяц; 3 - Год |
| yymm | При пустом значении будет выводиться календарь за текущий месяц. |
